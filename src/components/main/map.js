!function () {
    ...
    function t(o) {
        for (var t = document.querySelectorAll("." + o),
            i = 0; i < t.length; i++)t[i].style.display = "none"
    }
    function i(o, t) {
    ...
    window.DG = window.DG || {},
        ...
        window.DGWidgetLoader = function (n) {
            t("dg-widget-link"), o("firmsonmap_biglink"), o("firmsonmap_biglink_photo"), o("firmsonmap_biglink_route"),
                n = n || {},
                n.org = n.org || [],
                n.pos = n.pos || {},
                n.opt = n.opt || {};
            ...
            e = e.toString(),
                "%" != e.slice(-1) && (e = parseInt(e, 10),
                    e = Math.min(1200, e), e = Math.max(500, e));
            var d = n.height || 600; d = d.toString(),
                "%" != d.slice(-1) && (d = parseInt(d, 10),
                    d = Math.min(1e3, d), d = Math.max(400, d));
            for (var s = n.borderColor || "#a3a3a3",
                a = "", g = 0;
                g < n.org.length;
                g++)n.org[g].id && (a += n.org[g].id + ",");
            a = a.slice(0, -1);
